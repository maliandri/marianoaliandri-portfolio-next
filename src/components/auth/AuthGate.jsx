...
// - con user → children
export default function AuthGate({ children, title = 'Contenido para usuarios registrados', subtitle }) {
  ...
  if (!user) {
    return (
      <div className="max-w-md mx-auto text-center py-16 px-4">
        ...
        <p className="text-gray-600 text-xs mt-4">Gratis. Sin tarjeta.</p>
      </div>
    );
  }
