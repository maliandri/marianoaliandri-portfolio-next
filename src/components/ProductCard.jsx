          ...
          {isCustom ? (
            ...
            <div className="mb-3 space-y-0.5">
              <p className="text-base font-bold text-gray-900 dark:text-gray-100">
                Seña: {fx.rate ? formatARS(Math.ceil(sena * fx.rate)) : `USD ${sena}`}
              </p>
              <p className="text-base font-bold text-gray-900 dark:text-gray-100">
                {fx.rate ? formatARS(Math.ceil(monthlyRate * fx.rate)) : `USD ${monthlyRate}`}/mes
              </p>
            ...
            <div className="mb-3">
              {fx.loading ? (
                ...
                <>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">
                    Precio en pesos • Cotización del día
                  </p>
                </>
              )}
            </div>
