    ...
    <div className="flex items-center gap-1.5 min-w-[180px]">
      ...
      <button
        ...
        className={`shrink-0 px-2.5 py-1 rounded-full text-[11px] font-semibold transition-colors
          ${localCount > 0         ? 'bg-green-100 text-green-700 dark:bg-green-500/10 dark:text-green-400 hover:bg-green-200 dark:hover:bg-green-500/20'
          : busy === 'generating' ? 'bg-gray-100 dark:bg-gray-800 text-gray-400 cursor-wait'
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between mb-1">
              <label className="text-[11px] font-bold uppercase tracking-widest text-gray-500 dark:text-gray-400">Cuerpo del email (podés editarlo)</label>
              ...
              {source === 'template' && <span className="text-[10px] px-1.5 py-0.5 rounded-full bg-amber-50 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400" title="Gemini no disponible — se usó una plantilla">Plantilla</span>}
            </div>
            <textarea
              value={emailText}
              ...
              rows={10}
              disabled={!!busy}
              className="w-full text-sm bg-gray-50 dark:bg-gray-800/40 border border-gray-200 dark:border-neutral-700 rounded-xl p-3 text-gray-700 dark:text-gray-200 leading-relaxed focus:outline-none focus:ring-2 focus:ring-indigo-400/50 resize-y disabled:opacity-60"
            />
